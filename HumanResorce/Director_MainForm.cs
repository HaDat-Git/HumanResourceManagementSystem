...
{
    public partial class Director_MainForm : Form
    {
        private int borderSize = 2;
        public Director_MainForm()
        {
            InitializeComponent();
            CollapseMenu();
        ...
        private void Director_MainForm_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void Director_MainForm_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }
